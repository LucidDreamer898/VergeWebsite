...
export default function Navbar(){
  ...
  return(
    <div className="md:visible invisible absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-background z-30 text-xl text-text-light center font-quicksand">
      <div className="justify-evenly flex w-full lg:w-2/3">
